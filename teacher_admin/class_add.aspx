<%@ Page Title="" Language="C#" MasterPageFile="~/teacher_admin/t_admin.master" AutoEventWireup="true" CodeBehind="class_add.aspx.cs" Inherits="IE_Class.teacher_admin.class_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="Content">
        ...
        <table style="width:600px;margin:10px auto; ">
            ...
            <tr>
                <td>课程权重</td>
                <td style="text-align:left;"><asp:DropDownList runat="server" ID="DropDownList1" Width="50" Font-Size="Large">
